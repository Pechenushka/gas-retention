...
class GasRetentionSimulator extends React.Component {
    ...
    render() {
        let startBtnText = 'Почати симуляцію';
        if (this.state.isPlaying) {
            startBtnText = 'Зупинити симуляцію';
        }

        return <React.Fragment>
            <nav className="navbar navbar-expand-md navbar-light bg-light d-flex justify-content-between">
                <span className="navbar-brand mb-0 h1">Симулятор утримання газу</span>

                <ul className="navbar-nav">
                    <li className="nav-item">
                        <a className="nav-link" href="#" onClick={this.onResetClick.bind(this)}>Скинути</a>
                    </li>
                    <li className="nav-item">
                        <a className="nav-link" href="#" data-toggle="modal" data-target="#helpModal">Довідка</a>
                    </li>
                    <li className="nav-item">
                        <a className="nav-link" href="#" data-toggle="modal" data-target="#aboutModal">Про проект</a>
                    </li>
                </ul>
            </nav>
            ...
            <div className="row mt-2">
                ...
                <div className="custom-control custom-checkbox">
                    ...
                    <label className="custom-control-label"
                        ...
                        Дозволити вихід частинок з камери
                    </label>
                </div>
                ...
                <div className="col-6">
                    ...
                    <div className="form-check form-check-inline">
                        <input className="form-check-input"
                            ...
                            Показати інформацію про розподіл вибраного газу
                            </label>
                    </div>

                    <h6 className="mt-2">Гази</h6>
                            ...
                            <div className="form-group">
                                {this.state.activeGases.length < 3 &&
                                 <select className="form-control form-control-sm"
                                     ...
                                     <option value={-1}>Виберіть газ для додавання</option>
    ...
    onParticleCountUpdated(idx, newProportion) {
        ...
        // Тут пропорція не може рости тільки зжиматись
